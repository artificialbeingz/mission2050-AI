...
export const riskCategoryConfig: Record<RiskCategory, { label: string; abbr: string; color: string; icon: string }> = {
  compliance: { label: 'Compliance', abbr: 'C', color: '#2ECC71', icon: 'shield-check' },
  legal: { label: 'Legal', abbr: 'L', color: '#E74C3C', icon: 'scale' },
  operational: { label: 'Operational', abbr: 'O', color: '#3498DB', icon: 'settings' },
  strategic: { label: 'Strategic', abbr: 'S', color: '#9B59B6', icon: 'target' },
  reputational: { label: 'Reputational', abbr: 'R', color: '#E67E22', icon: 'users' },
  cybersecurity: { label: 'Cybersecurity', abbr: 'CY', color: '#1ABC9C', icon: 'lock' },
  financial: { label: 'Financial', abbr: 'F', color: '#F1C40F', icon: 'dollar-sign' },
  people_workforce: { label: 'People & Workforce', abbr: 'PW', color: '#95A5A6', icon: 'users' },
};
...
export const companyRiskProfiles: Record<string, CompanyRiskProfile> = {
  'comp-reg-001': { // Royal Bank of Canada
    ...
    risks: [
      ...
      { id: 'R-004', category: 'legal', description: 'Class action lawsuit on mortgage lending practices', score: 18, status: 'active', severity: 'severe', likelihood: 'extreme', owner: 'General Counsel', lastUpdated: '2024-04-17', mitigationActions: ['Legal defense preparation', 'Settlement analysis'],
      ...
      { id: 'R-005', category: 'legal', description: 'Regulatory investigation into trading practices', score: 17, status: 'active', severity: 'severe', likelihood: 'extreme', owner: 'Legal Director', lastUpdated: '2024-04-16', mitigationActions: ['Document retention', 'Internal investigation'],
      ...
      { id: 'R-014', category: 'legal', description: 'Intellectual property disputes with fintech partners', score: 10, status: 'monitoring', severity: 'moderate', likelihood: 'medium', owner: 'Legal Counsel', lastUpdated: '2024-04-07', mitigationActions: ['Contract review', 'IP audit'],
      ...
      { id: 'R-023', category: 'legal', description: 'Contract renewal disputes with suppliers', score: 8, status: 'monitoring', severity: 'minor', likelihood: 'likely', owner: 'Procurement Legal', lastUpdated: '2024-03-28', mitigationActions: ['Contract review', 'Negotiation training'],
      ...
      { id: 'R-024', category: 'legal', description: 'Employee grievance procedures review needed', score: 7, status: 'monitoring', severity: 'minor', likelihood: 'likely', owner: 'HR Legal', lastUpdated: '2024-03-27', mitigationActions: ['Policy update', 'Manager training'],
    ...
    risksByCategory: {
      ...
      legal: { count: 5, high: 0, critical: 2 },
    ...
    heatMapData: [
      ...
      { likelihood: 'extreme', severity: 'severe', count: 4, categories: { cybersecurity: 2, legal: 2 } },
      ...
      { likelihood: 'medium', severity: 'moderate', count: 4, categories: { compliance: 1, legal: 1, strategic: 2 } },
      { likelihood: 'medium', severity: 'major', count: 4, categories: { reputational: 2, operational: 2 } },
      { likelihood: 'likely', severity: 'minor', count: 5, categories: { compliance: 2, legal: 2, strategic: 1 } },
  ...
  'comp-reg-002': { // Suncor Energy
    ...
    risksByCategory: {
      ...
      legal: { count: 4, high: 2, critical: 0 },
    ...
    heatMapData: [
      ...
      { likelihood: 'extreme', severity: 'major', count: 4, categories: { compliance: 2, legal: 2 } },
      { likelihood: 'high', severity: 'major', count: 6, categories: { compliance: 2, operational: 3, cybersecurity: 1 } },
      { likelihood: 'high', severity: 'moderate', count: 3, categories: { legal: 2, reputational: 1 } },
  ...
  'comp-reg-003': { // Shopify
    ...
    heatMapData: [
      ...
      { likelihood: 'medium', severity: 'moderate', count: 8, categories: { compliance: 2, operational: 2, legal: 2, reputational: 1, cybersecurity: 1 } },
      { likelihood: 'medium', severity: 'minor', count: 2, categories: { strategic: 2 } },
      { likelihood: 'likely', severity: 'minor', count: 4, categories: { compliance: 1, legal: 1, operational: 1, reputational: 1 } },
  ...
  'comp-reg-004': { // Pfizer Canada
    ...
    heatMapData: [
      ...
      { likelihood: 'high', severity: 'moderate', count: 2, categories: { legal: 1, cybersecurity: 1 } },
      { likelihood: 'medium', severity: 'major', count: 3, categories: { operational: 2, cybersecurity: 1 } },
      { likelihood: 'medium', severity: 'moderate', count: 8, categories: { compliance: 2, legal: 2, operational: 1, strategic: 1, reputational: 2 } },
