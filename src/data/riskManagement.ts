...
export const companyRiskProfiles: Record<string, CompanyRiskProfile> = {
  ...
  'comp-reg-003': { // Shopify
    ...
    heatMapData: [
      ...
      { likelihood: 'medium', severity: 'moderate', count: 8, categories: { compliance: 2, operational: 2, operational: 2, reputational: 1, cybersecurity: 1 } },
      { likelihood: 'medium', severity: 'minor', count: 2, categories: { strategic: 2 } },
      { likelihood: 'likely', severity: 'minor', count: 4, categories: { compliance: 1, operational: 1, operational: 1, reputational: 1 } },
  ...
  'comp-reg-004': { // Pfizer Canada
    ...
    heatMapData: [
      ...
      { likelihood: 'medium', severity: 'moderate', count: 8, categories: { compliance: 2, operational: 2, operational: 1, strategic: 1, reputational: 2 } },
